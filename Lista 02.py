...
def  questao3():
    ...
    e = int(input())
    resto = (h + e) % 24
    return ('O depertador tocará ás', resto,'horas.')
...
def questao7():
    ...
    return ('O valor do jutos depois de', t,'é ', a,'.')
...
def questao9():
    ...
    la = float(input())
    ar = al * la
    return ('A área do retângulo é:', ar)
...
def questao10():
    ...
    l = float(input())
    gasto = km / l 
    return ('O carro consume ', gasto, 'litros por km.')


def questao11():
    print('Entre com a temperatura em C')
    ce =int(input())
    return (' A temperatura em fahrenheit é', ((ce * 9) / 5) + 32)


def questao12():
    print('Entre com a temperatura em F')
    fa=int(input())
    return ('A temperatura em Celsius é', ((fa - 32) * 5) / 9)
